...
const COMMON_EDITORS_LINUX:any = {
  atom: 'atom',
  Brackets: 'brackets',
  code: 'code',
  ...
  switch (editorBasename) {
    ...
    case 'VSCodium':
      return addWorkspaceToArgumentsIfExists(
        ['-r', '-g', fileName + ':' + lineNumber + ':' + colNumber],
        workspace
      )
    case 'appcode':
    case 'clion':
...
function printInstructions(fileName:any, errorMessage:any) {
  console.log()
  ...
  if (errorMessage) {
    ...
    console.log('The editor process exited with an error: ' + errorMessage)
  }
  console.log()
  console.log(
...
function launchEditor(fileName:any, lineNumber:any, colNumber?:any) {
  ...
  _childProcess.on('exit', function (errorCode:any) {
    _childProcess = null
  ...
  _childProcess.on('error', function (error:any) {
